...
{
    class TenseConverterExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/tenseconverter";

        /// <summary>
        /// Make a POST request to the Tense Converter API
        /// </summary>
        static async Task<JsonDocument> CallTenseConverterAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { text &#x3D; &quot;I am walking down the street, and I can see a dog&quot;, tense &#x3D; &quot;past&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Tense Converter API...\n");

            var result = await CallTenseConverterAPI();
