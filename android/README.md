...
```gradle
dependencies {
    implementation 'com.github.apiverve:tenseconverter-api:1.1.14'
}
```
...
```java
import com.apiverve.tenseconverter.TenseConverterAPIClient;
import com.apiverve.tenseconverter.APIResponse;
import com.apiverve.tenseconverter.APIException;

// Initialize the client
TenseConverterAPIClient client = new TenseConverterAPIClient("YOUR_API_KEY");

try {
    // Prepare request parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("text", "I am walking down the street, and I can see a dog");
    parameters.put("tense", "past");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/tenseconverter](https://docs.apiverve.com/ref/tenseconverter)
...
- **Documentation:** [https://docs.apiverve.com/ref/tenseconverter](https://docs.apiverve.com/ref/tenseconverter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/tenseconverter-api/issues)
