...
class tenseconverterWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/tenseconverter');
        }
        ...
        this.validationRules = {"text":{"type":"string","required":true},"tense":{"type":"string","required":true,"default":"past"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/tenseconverter`);
        }
    }
