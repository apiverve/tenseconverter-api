...
namespace APIVerve.API.TenseConverter
{
    ...
    /// <summary>
    /// Client for the TenseConverter API
    /// </summary>
    public class TenseConverterAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/tenseconverter";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "tense", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public TenseConverterAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TenseConverterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TenseConverterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, TenseConverterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(TenseConverterQueryOptions options)
        {
        ...
        public ResponseObj Execute(TenseConverterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(TenseConverterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(TenseConverterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(TenseConverterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(TenseConverterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(TenseConverterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(TenseConverterQueryOptions options)
        {
