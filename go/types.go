...
// Request contains the parameters for the Tense Converter API.
//
// Parameters:
...
type Request struct {
	...
	Tense string `json:"tense"` // Required
}
...
// ResponseData contains the data returned by the Tense Converter API.
